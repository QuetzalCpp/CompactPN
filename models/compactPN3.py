...
from . import networks_compact
import pickle
import numpy

class compactPN3Model(BaseModel):
    def name(self):
        return 'compactPN3_Model'
    ...
    def initialize(self, opt):
        ...
        self.netG = networks_compact.define_network(opt.input_nc, None, opt.model,
    ...
    def backward(self):
        ...
        self.loss_G += (mse_pos * self.opt.beta) * 0.3
        self.loss_pos += mse_pos.item() * 0.3
    ...
    def get_current_errors(self):
        ...
        pos_err = torch.dist(self.pred_B[0], self.input_B[:, 0:3]) # return norm(ED)
        return [pos_err.item()]
